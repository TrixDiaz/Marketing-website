...
export default function CardFlip({
    ...
    return (
        <div
            className="relative w-full max-w-[340px] h-[380px] group perspective-[2000px]"
        ...
        >
            ...
            >
                ...
                >
                    <div className="absolute inset-0 bg-linear-to-b from-white/80 via-white/40 to-white/0 dark:from-zinc-900 dark:via-zinc-900/60 dark:to-black" />
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(251,146,60,0.18),transparent_35%)]" />
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_0%,rgba(14,165,233,0.12),transparent_30%)]" />

                    <div className="relative flex h-full flex-col justify-around p-6">
                        <div className="space-y-3">
                            <div className="inline-flex w-fit items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-xs font-semibold text-orange-600 backdrop-blur-sm dark:bg-zinc-800/60 dark:text-orange-300">
                                <span>Premium service</span>
                            </div>
                            <div className="space-y-1">
                                <h3 className="text-3xl font-semibold text-zinc-900 dark:text-white leading-snug tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-4px]">
                                    {title}
                                </h3>
                                <p className="text-lg text-zinc-600 dark:text-zinc-200 line-clamp-2 tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-2px] delay-[50ms]">
                                    {subtitle}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-xs font-medium text-zinc-700 backdrop-blur-sm dark:bg-zinc-800/70 dark:text-zinc-200">
                ...
                >
                    <div className="flex-1 space-y-6">
                        <div className="space-y-2">
                            <h3 className="text-xl font-semibold text-zinc-900 dark:text-white leading-snug tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-2px]">
                                {title}
                            </h3>
